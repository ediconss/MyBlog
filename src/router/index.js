...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      { path: 'article', name: 'article', component: () => import('@/views/table/article'), meta: { title: 'article', icon: 'table' }},
      { path: 'label', name: 'label', component: () => import('@/views/table/label'), meta: { title: 'label', icon: 'table' }},
